...
\usepackage[paperwidth=40in, paperheight=30in, margin=1.08in, top=0in, bottom=0in, left=1.08in, right=1.08in, includeheadfoot=false]{geometry}
...
\renewcommand{\normalsize}{\fontsize{21pt}{26pt}\selectfont}
\renewcommand{\small}{\fontsize{18pt}{23pt}\selectfont}
\renewcommand{\footnotesize}{\fontsize{17pt}{21pt}\selectfont}
\renewcommand{\large}{\fontsize{26pt}{31pt}\selectfont}
\renewcommand{\Large}{\fontsize{31pt}{36pt}\selectfont}
\renewcommand{\LARGE}{\fontsize{38pt}{43pt}\selectfont}
\renewcommand{\huge}{\fontsize{50pt}{57pt}\selectfont}
\renewcommand{\Huge}{\fontsize{70pt}{78pt}\selectfont}
...
% =====================================================================
\noindent\hspace*{-1.08in}%
\colorbox{brandorange}{%
\begin{minipage}[c][2.83in][c]{\dimexpr\paperwidth-2\fboxsep\relax}
\begin{minipage}[c]{0.20\paperwidth}\hfill\end{minipage}%
\begin{minipage}[c]{0.60\paperwidth}
\centering
\color{white}\sffamily
{\fontsize{63pt}{72pt}\selectfont \bfseries Spectral Filtering for Vision--Language--Action Models}\\[0.8em]
{\fontsize{23pt}{27pt}\selectfont Shivam Kak [sk3686@princeton.edu]\,$^{1}$ \quad
 Ishan Saha [is1893@princeton.edu]\,$^{1}$ \quad
 Connor Brown [cb6856@princeton.edu]\,$^{1}$}\\[0.35em]
{\fontsize{20pt}{23pt}\selectfont $^{1}$Princeton University}
\end{minipage}%
\begin{minipage}[c]{0.20\paperwidth}
\centering
\includegraphics[height=1.67in]{../../princeton_logo.png}
\end{minipage}%
\end{minipage}%
}
...
\noindent\hspace*{-1.08in}%
\colorbox{brandorange}{%
\begin{minipage}[c][0.83in][c]{\dimexpr\paperwidth-2\fboxsep\relax}
\color{white}\sffamily
\hspace*{1.25in}{\Large \href{https://github.com/ishansaha01/vla-stu}{\color{white}\texttt{https://github.com/ishansaha01/vla-stu}}} \hfill
{\Large \bfseries ECE 534} \hfill
{\Large \texttt{sk3686, is1893, cb6856 @princeton.edu}}\hspace*{1.25in}
\end{minipage}%
}
